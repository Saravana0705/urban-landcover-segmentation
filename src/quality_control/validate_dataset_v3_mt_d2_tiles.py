"""Independently validate all materialized V3-MT-D2 tile triplets."""
...
def main() -> None:
    ...
    for position, row in frame.iterrows():
        ...
        city_rows.append({
            ...
            "parent_valid_pixel_count": int(row["parent_v3_mt_valid_pixel_count"]),
    ...
    report = {
        "schema_version": "dataset-v3-mt-d2-tile-qa-0.1",
        ...
        "validation_policy": "V3-MT validity intersect all-16-band validity",
    }
    args.output.parent.mkdir(parents=True, exist_ok=True)
    args.output.write_text(json.dumps(report, indent=2) + "\n", encoding="utf-8")
    summary_path = args.output.parent / "dataset_v3_mt_d2_city_qa_summary.csv"
