"""Independently validate all materialized V3-MT-D1 tile triplets."""
...
def main() -> None:
    ...
    report = {
        "schema_version": "dataset-v3-mt-d1-tile-qa-0.1",
        ...
        "validation_policy": "V3-MT validity intersect all-24-band validity",
    }
    args.output.parent.mkdir(parents=True, exist_ok=True)
    args.output.write_text(json.dumps(report, indent=2) + "\n", encoding="utf-8")
    summary_path = args.output.parent / "dataset_v3_mt_d1_city_qa_summary.csv"
