"""Compute leakage-free eight-band Dataset V3-MT normalization constants."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=Path("metadata/dataset_v3_mt/normalization"),
    )
...
def main() -> None:
    ...
    for city_position, city in enumerate(training_cities):
        ...
        with rasterio.open(path) as dataset:
            if dataset.count != 8 or tuple(dataset.descriptions) != EXPECTED_BANDS:
    ...
    normalization = {
        "schema_version": "dataset-v3-mt-training-normalization-0.1",
    ...
    provenance = {
        "schema_version": "dataset-v3-mt-normalization-provenance-0.1",
        "generated_at_utc": generated_at,
        "status": "PASS",
