"""Compute leakage-free 16-band Dataset V3-MT-D2 normalization constants."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=Path("metadata/dataset_v3_mt_d2/normalization"),
    )
...
def main() -> None:
    ...
    for city_position, city in enumerate(training_cities):
        ...
        with rasterio.open(path) as dataset:
            if dataset.count != 16 or tuple(dataset.descriptions) != EXPECTED_BANDS:
    ...
    normalization = {
        "schema_version": "dataset-v3-mt-d2-training-normalization-0.1",
    ...
    provenance = {
        "schema_version": "dataset-v3-mt-d2-normalization-provenance-0.1",
        "generated_at_utc": generated_at,
        "status": "PASS",
