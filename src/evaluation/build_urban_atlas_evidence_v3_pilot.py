"""Build non-final Urban Atlas evidence rasters and three-source pilot statistics."""
...
def build(args) -> tuple[dict, list[dict]]:
    ...
    report = {
        "audit_version": "v3-pilot-three-source-0.1",
...
def main() -> None:
    ...
    parser.add_argument("--report-dir", type=Path, default=Path("metadata/dataset_v3/pilot/three_source_audit"))
