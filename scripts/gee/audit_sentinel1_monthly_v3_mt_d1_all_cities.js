...
// Audit only: this script deliberately creates no image export tasks.
// City grids and anchor times are inherited unchanged from frozen V3-MT.
var EXPORT_FOLDER = 'S1_MT_D1_MONTHLY_AUDIT_2025';
...
print('Dataset V3-MT-D1 monthly acquisition audit (20 cities):',
      acquisitionAudit);
Export.table.toDrive({
  collection: acquisitionAudit,
  description: 'dataset_v3_mt_d1_monthly_acquisition_audit_2025',
  folder: EXPORT_FOLDER,
  fileNamePrefix: 'dataset_v3_mt_d1_monthly_acquisition_audit_2025',
  fileFormat: 'CSV'
});
